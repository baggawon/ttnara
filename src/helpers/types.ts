...
export enum ApiRoute {
  ...
  adminBoardRanksCreate = "/api/admin_di2u3k2j/board_ranks/create",
  adminBoardRanksRead = "/api/admin_di2u3k2j/board_ranks/read",
  adminBoardRanksUpdate = "/api/admin_di2u3k2j/board_ranks/update",
  adminBoardRanksDelete = "/api/admin_di2u3k2j/board_ranks/delete",
  adminBoardRanksBatchCreate = "/api/admin_di2u3k2j/board_ranks/batch-create",
  attendanceRead = "/api/attendance/read",
  attendanceCheckin = "/api/attendance/checkin",
  profileSummary = "/api/profile/summary",
  adminAttendanceSettingRead = "/api/admin_di2u3k2j/attendance/setting/read",
  adminAttendanceSettingUpdate = "/api/admin_di2u3k2j/attendance/setting/update",
  adminAttendanceStreaksRead = "/api/admin_di2u3k2j/attendance/streaks/read",
  adminAttendanceStreaksCreate = "/api/admin_di2u3k2j/attendance/streaks/create",
  adminAttendanceStreaksUpdate = "/api/admin_di2u3k2j/attendance/streaks/update",
  adminAttendanceStreaksDelete = "/api/admin_di2u3k2j/attendance/streaks/delete",
  adminBoardRankBadgesList = "/api/admin_di2u3k2j/board_rank_badges/list",
  adminBoardRankBadgesUpload = "/api/admin_di2u3k2j/board_rank_badges/upload",
  adminBoardRankBadgesAssign = "/api/admin_di2u3k2j/board_rank_badges/assign",
  adminBoardRankBadgesUnassign = "/api/admin_di2u3k2j/board_rank_badges/unassign",
  adminBoardRankBadgesDelete = "/api/admin_di2u3k2j/board_rank_badges/delete",
  ...
  adminChatSpamUsers = "/api/admin_di2u3k2j/chat/moderation/spam-users",
...
export enum QueryKey {
  ...
  boardRankBadges = "boardRankBadges",
...
export enum AdminAppRoute {
  ...
  BoardRanks = "/admin/board-ranks",
  Attendance = "/admin/attendance",
  BoardRankBadges = "/admin/board-ranks/badges",
