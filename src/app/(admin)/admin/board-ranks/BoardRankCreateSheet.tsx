...
import { useAdminBoardRanksCreateHook } from "@/app/(admin)/admin/board-ranks/create/hook";
...
export default function BoardRankCreateSheet() {
  const closeRef = useRef<HTMLButtonElement>(null);
  const { methods, submit, isSubmitting } = useAdminBoardRanksCreateHook(() => {
