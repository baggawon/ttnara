      ...
      <Card className="mt-4">
        <CardHeader>
          <div className="flex flex-wrap items-center justify-between gap-2">
            <CardTitle className="min-w-0">QnA 목록</CardTitle>
            <div className="flex gap-2 shrink-0">
              <Button onClick={handleCreate} size="sm" aria-label="QnA 추가">
                <Plus className="w-4 h-4 sm:mr-1.5" />
                <span className="hidden sm:inline">QnA 추가</span>
              </Button>
              <Button
        ...
        <CardContent>
          {isLoading ? (
            ...
            <DataTable columns={columns} data={qnaData?.qnas ?? []} />
          )}
        </CardContent>
      </Card>
    </>
